...
<div class="head-banner">
    <div class="head-banner__content">
        <div class="head-banner__parallax">
            <div class="head-banner__parallax-inner head-banner__parallax-inner--clamp">
                <ul id="scene" class="head-banner__parallax-scene">
                    <li class="head-banner__parallax-layer" data-depth="0.10"><img src="/media/images/clamp.png" alt=""></li>
                    <li class="head-banner__parallax-layer head-banner__parallax-layer--small" data-depth="0.50"><img src="/media/images/clamp-sm.png" alt=""></li>
                </ul>
            </div>
        </div>
        <div class="head-banner__title">
            <h1 class="double-text" data-name="Клеммы">Клеммы</h1>
        </div>
        <div class="head-banner__nav">
            <a href="/page-accum.php" class="head-banner__nav-button head-banner__nav-button--prev">
                ...
                <div class="head-banner__nav-button-image">
                    <img src="/media/images/pic-4.png" alt="Клемы">
                </div>
            </a>
            <a href="/page-oil.php" class="head-banner__nav-button head-banner__nav-button--next">
                <div class="head-banner__nav-button-image">
                    <img src="/media/images/pic-3.png" alt="Автохимия">
                </div>
                <span class="head-banner__nav-button-title">Моторные масла</span>
                <img src="/media/images/arrow.svg" alt="arrow" class="head-banner__nav-button-arrow">
            </a>
        </div>
    </div>
